...
pkgs = value_for_platform(
  ...
  [ "debian", "ubuntu" ] => {
    "default" => %w{ php5-cgi php5 php5-dev php5-cli php-pear php5-xdebug php5-tidy php5-sqlite php5-redis php5-pgsql php5-memcache php5-memcached php5-mcrypt php5-http php5-gmp php5-gd php5-curl php5-apc }
  },
